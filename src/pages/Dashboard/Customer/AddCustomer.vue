      ...
      <card>
        <div slot="header">
          <h5 class="title">
            ...
            </n-button> {{$route.name.toUpperCase()}}</h5>
        </div>
        <form>
          <div class="row">
            <label class="col-md-2 col-form-label offset-md-3 text-right">NAME <span class="red">*</span></label>
            <div class="col-md-3">
          ...
          <!-- <div class="row">
            <label class="col-md-2 col-form-label offset-md-3 text-right">GENDER <span class="red">*</span></label>
            <div class="col-md-3">
              <fg-input type="text" v-model="customer.gender"></fg-input>
            </div>
          </div> -->
          ...
          <div class="row">
            <label class="col-md-2 col-form-label offset-md-3 text-right">AGE <span class="red">*</span></label>
            <div class="col-md-3">
          ...
          <div class="row">
            <div id="btnAdd" class="col-md-6 offset-md-6">
              <n-button class="button" type="info" @click.native="createCustomer()">ADD</n-button>
            </div>
          </div>
        </form>
      </card>
    ...
    async createCustomer() {
      if (this.customer.name === "" || this.customer.name === undefined) {
        ...
        try {
            ...
            swal({
            title: `You added ${this.customer.name.trim()}`,
            buttonsStyling: false,
            type: "success",
            confirmButtonClass: "btn btn-success btn-fill",
            onClose: () => {
